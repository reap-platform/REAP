...
DROP SCHEMA IF EXISTS REAP_PORTAL;

CREATE SCHEMA REAP_PORTAL;
...
DROP TABLE IF EXISTS REAP_PORTAL.USER_SETTING;
...
DROP TABLE IF EXISTS REAP_PORTAL.USER_FAV_FUNCTION;
...
DROP TABLE IF EXISTS REAP_PORTAL.USER_SETTING_FAV_FUNCTIONS;
...
DROP TABLE IF EXISTS REAP_PORTAL.MENU;
